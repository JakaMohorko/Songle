...
public class AchievementsViewTest {

    @Rule
    public ActivityTestRule<LoadSongList> mActivityTestRule = new ActivityTestRule<>(LoadSongList.class);

    @Test
    public void achievementsViewTest() {
        ViewInteraction button = onView(
                allOf(ViewMatchers.withId(R.id.button16), withText("Achievements"),
                        childAtPosition(
                                childAtPosition(
        ...
        allOf(withText("Collect 100 placemarks"),isDisplayed());
